      ...
      <section className="pt-20 pb-6 md:pt-32 md:pb-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-label font-label mb-4 text-gray-900">Data Integration Solutions</h1>
      ...
      <section className="overflow-hidden bg-gray-50 py-10 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            <h2 className="text-label font-label mb-2 md:mb-4">Client Success Stories</h2>
            <p className="text-desc font-desc text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-xl shadow-lg p-5 md:p-8 mb-8">
              <div className="flex flex-col md:flex-row items-start md:items-center mb-4">
                ...
                <div className="md:ml-4">
                  <h3 className="text-label font-label">Michael Chen</h3>
                  <p className="text-desc font-desc text-gray-600">CTO</p>
                  <p className="text-desc font-desc text-gray-500">FinanceHub</p>
                </div>
              </div>
              <div className="relative">
                ...
                <p className="text-desc font-desc text-gray-700 italic relative pl-6 leading-relaxed">
                  "The data integration platform from GenZBot has been a game-changer for our financial services. We're now able to process transactions 60% faster while maintaining complete data integrity. Their technical support is always responsive and helpful."
                </p>
              </div>
            </div>
            ...
            <div className="text-center mt-6 md:mt-10">
              <a 
                href="#contact" 
                className="text-btn font-btn bg-[var(--color-secondary)] text-white px-6 py-3 rounded-md transition-colors inline-flex items-center hover:bg-[var(--color-secondary-hover)]"
              >
                Request a Demo
