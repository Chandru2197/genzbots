...
const EXISTING_PAGES = [
  ...
  '/service',
  '/services',
  '/automation-process/bot-blueprint',
  '/automation-process/build-and-test',
  '/automation-process/discovery-call',
  '/automation-process/hyper-care',
  '/automation-process/scale-optimize',
  '/solutions',
