              ...
              {menuItems.map((item, index) => (
                ...
                >
                  {item.dropdown || item.label === 'Services' ? (
                    ...
                    <Link
                      href={item.href}
                      className="text-black font-bold transition-all duration-300 relative px-4 py-2 rounded-2xl hover:text-blue-600 group "
                      style={{
                        backdropFilter: 'blur(10px)',
                        WebkitBackdropFilter: 'blur(10px)',
                      }}
            ...
            <div className="hidden lg:block">
              ...
              >
                ...
                >
                  ...
                  <svg
                    viewBox="0 0 24 24"
                    className="absolute w-4 fill-[#022564] z-[9] transition-all duration-700 ease-custom right-2 group-hover:-right-1/4 group-hover:fill-[#ff8904]"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <path
                      d="M16.1716 10.9999L10.8076 5.63589L12.2218 4.22168L20 11.9999L12.2218 19.778L10.8076 18.3638L16.1716 12.9999H4V10.9999H16.1716Z"
