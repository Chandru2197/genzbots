      ...
      <div className="p-4 md:p-8 h-auto md:h-auto max-h-[500px] md:max-h-none overflow-y-auto">
        <div className="flex flex-col md:flex-row items-start md:items-center mb-3 md:mb-6">
          ...
          <div className="md:ml-4">
            <h3 className="text-label font-label">{testimonial.name}</h3>
            <p className="text-desc font-desc text-gray-600">{testimonial.position}</p>
            <p className="text-desc font-desc text-gray-500">{testimonial.company}</p>
          </div>
        </div>
        <div className="relative">
          ...
          <p className="text-desc font-desc text-gray-700 italic relative pl-4 md:pl-6 leading-relaxed line-clamp-6 md:line-clamp-none">
            "{testimonial.text}"
          </p>
        </div>
      </div>
    ...
    <section className="py-8 md:py-16 bg-gray-50 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-6 md:mb-12">
          <h2 className="text-label font-label mb-3 md:mb-4">What Our Clients Say</h2>
