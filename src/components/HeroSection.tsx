    ...
    >
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
          ...
          >
            <h1 className="text-9xl font-bold leading-tight text-[var(--color-primary-dark)] mb-4">
              Simplify Automate Elevate
            </h1>
            <h6 className="text-5xl font-label leading-tight text-[var(--color-primary-dark)] mb-4 border-b p-1">
              Digital workflow solutions for forward-thinking businesses
            </h6>
            <p className="text-xl font-desc text-[var(--color-primary-dark)] mb-8">
